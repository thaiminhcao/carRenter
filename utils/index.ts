import { CarProps, DataLoginProps, FilterProps } from "@types";
...
export async function fetchCars(filters: FilterProps) {
  ...
  const headers: HeadersInit = {
    "X-RapidAPI-Key": "9216fc5104msh2396df154f32b32p144ecdjsn961774b132a0",
...
export async function fetchUserRegister(data: DataLoginProps) {
  const headers = {
